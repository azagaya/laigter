...
float LightSource::get_height(){
    return settings.lightPosition.z();
}
...
float LightSource::get_specular_scatter(){
    return  settings.specularScatter;
}
...
float LightSource::get_diffuse_intensity(){
    return settings.diffuseIntensity;
}
